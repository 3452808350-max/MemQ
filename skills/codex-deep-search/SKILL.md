...
```bash
nohup bash /home/kyj/.openclaw/workspace/skills/codex-deep-search/scripts/search.sh \
  --prompt "Your research query" \
  --task-name "notebooklm-research" \
  --telegram-group "8278708856" \
...
```bash
bash /home/kyj/.openclaw/workspace/skills/codex-deep-search/scripts/search.sh \
