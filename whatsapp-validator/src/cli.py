...
"""
    ...
    parser.add_argument(
        '--phone-column',
        default=None,
        help='Name of the phone number column (default: from config or phone)'
    )
    ...
    parser.add_argument(
        '--country',
        default=None,
        help='Default country code for phone number parsing (default: from config or US)'
    )
    ...
    parser.add_argument(
        ...
        default=None,
        help='WhatsApp check mode (default: from config or mock)'
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help='API requests per second (default: from config or 5.0)'
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help='Number of API retries (default: from config or 3)'
    )
...
def build_config(args: argparse.Namespace) -> Config:
    ...
    if args.input:
        ...
        if args.input_format:
            config.input.format = args.input_format
        else:
            # Auto-detect from extension only if not already set in config
            detected = detect_format(args.input)
            if detected:
                config.input.format = detected
