...
class WhatsAppChecker:
    ...
    def check(self, phone_number: str) -> WhatsAppCheckResult:
        """
    ...
    def _check_via_api(self, phone_number: str) -> WhatsAppCheckResult:
        """
        ...
        Returns:
            WhatsAppCheckResult
        """
        # Skip API check for invalid/empty numbers
        if not phone_number:
            logger.debug(f"Skipping API check for empty/invalid number")
            return WhatsAppCheckResult(
                phone_number=phone_number or '',
                status=WhatsAppStatus.UNKNOWN,
                source='api',
                error_message="Invalid phone number - API check skipped"
            )
    ...
    def _check_mock(self, phone_number: str) -> WhatsAppCheckResult:
        """
    ...
    def _check_estimated(self, phone_number: str) -> WhatsAppCheckResult:
        """
