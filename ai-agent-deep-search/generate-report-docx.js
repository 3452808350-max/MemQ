...
const mdContent = fs.readFileSync('ai-agent-coding-analysis-2026q1.md', 'utf8');
  ...
  sections: [{
    ...
    children: [
      ...
      new Paragraph({
        children: [
          new TextRun({
            text: "2026年Q1 AI Agent Coding 真实使用问题深度分析报告",
            bold: true,
            size: 48,
            font: "SimHei"
          })
      ...
      new Paragraph({
        children: [
          new TextRun({ text: "分析周期: 2026年1月-4月 | 数据来源: Hacker News (302+帖子) | 生成时间: 2026-04-08", size: 24, font: "SimSun" })
        ],
        alignment: AlignmentType.CENTER,
        spacing: { after: 600 }
      }),
...
Packer.toBuffer(doc).then(buffer => {
  fs.writeFileSync("ai-agent-coding-analysis-2026q1.docx", buffer);
  console.log("✅ Word 文档已生成: ai-agent-coding-analysis-2026q1.docx");
});